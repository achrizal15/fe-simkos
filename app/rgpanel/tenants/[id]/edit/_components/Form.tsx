...
import TypeTenantFormValues from "./TypeTenantFormValue"
import TenantInterface from "@/utils/Interfaces/TenantItemInterface"
import IdentificationDocumentSelect from "./IdentificationDocumentSelect"
...
const Form = ({ tenant }: { tenant: TenantInterface }) => {
